...
namespace FilmsCollectionApp.Models
{
    public partial class FilmsCollectionDBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                //var connectionstring=conf
                ////string connectionString = ConfigurationManager.ConnectionStrings["connection_string"].ConnectionString;
                //optionsBuilder.UseSqlServer("FilmsCollectionDB");
                optionsBuilder.UseSqlServer(@"Server = DARIAKRASHC6082; Database = FilmsCollectionDB; Trusted_Connection = True;");
